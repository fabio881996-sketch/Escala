...
# 2. CSS - DESIGN CORRIGIDO (APENAS SUBTÍTULOS BRANCOS)
st.markdown("""
    <style>
    /* FUNDO DA PÁGINA */
    .stApp { 
    ...
    /* --- CORREÇÃO SOLICITADA: SUBTÍTULOS BRANCOS --- */
    /* Forçamos o fundo do cabeçalho a ser escuro para o texto branco ser visível */
    ...
    /* Forçamos todas as letras e ícones dentro do cabeçalho a ser BRANCO */
    .streamlit-expanderHeader *, 
    ...
    /* TÍTULOS E TEXTOS DA PÁGINA (Preto para leitura) */
    h1, h2, h3, p {
        color: #1A1C1E !important;
    }
        ...
        if df_dia is not None:
            ...
            def filtrar_e_mostrar(titulo, keywords, excluir=True):
                ...
                if not temp_df.empty:
                    # O título deste expander aparecerá a BRANCO agora
