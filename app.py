...
# 2. CSS - ALTERAÇÃO APENAS NA COR DOS SUBTÍTULOS
st.markdown("""
    <style>
    /* FUNDO DA PÁGINA */
    .stApp { 
    ...
    /* CORREÇÃO AQUI: Título dos Blocos (Subtítulos) APENAS PARA BRANCO */
    .streamlit-expanderHeader {
        color: #FFFFFF !important;
        font-weight: bold !important;
        background-color: #455A64 !important; /* Adicionado fundo escuro para a letra branca ser visível */
        padding-top: 10px !important;
        padding-bottom: 10px !important;
    }
    
    /* Garante que o ícone da seta também fique branco */
